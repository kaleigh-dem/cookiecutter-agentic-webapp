...
Relevant merged work is recorded in PRs #2–#49 and `docs/adr/`.
...
- [x] **P11-07 Prove the workflow end to end.**
...
- [x] **P12-02 Add a production browser authentication adapter.**
...
- [x] **P12-04 Enforce generated HTTP contracts at runtime.**
...
### Phase 12 gate record — 2026-08-04
...
- Phase 12 exit criteria: PR #49 and commit `df6f4949a6962780857349673aaa9f473e6fa3de`, validated at exact head `40a3725a1576cf4d8506abd92cb2c50ecfab05ab` by CI #577, Delivery #320, Security #401, and Generated Workspace #257
