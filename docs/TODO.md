...
- [-] **P3-06** Verify generator unit tests, package resolution, formatting, typechecking, and build in CI.
...
- [ ] **P3-08** Document extension guidance for adding a fifth generator without weakening boundaries.
